...
const get = async <T>(
  ...
  try {
    ...
    toast.error("Something went wrong! Try again later", { id: "toast" }); // We gave it an id so that it would appear only once even in cases that we have multiple error in the fetch requests
